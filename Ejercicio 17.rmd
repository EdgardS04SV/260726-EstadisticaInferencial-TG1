...
donde: -λ mensual = 2.5 devoluciones/mes -λ trimestral = 2.5 × 3 = 7.5 devoluciones/trimestre
...
X = Número total de intentos necesarios para lograr el segundo reporte arreglado. X \~ Binomial Negativa(r = 2, p = 0.30)
...
X = Número de estudiantes que obtienen calificación de honor. X \~ Binomial(n = 12, p = 0.25)
...
pbinom() calcula probabilidades acumuladas P(X ≤ x). Para probabilidades del tipo "al menos", se utiliza el complemento.
